...
export const adminSections: Array<{
  ...
  { href: "/admin/operations", label: "运营位管理", description: "维护首页 Banner、推荐圈子、活动入口和今日话题。" },
  { href: "/admin/points", label: "积分规则", description: "配置发帖、评论、获赞和被收藏等积分规则。" },
  { href: "/admin/badges", label: "勋章头衔", description: "维护勋章、头衔定义和授予条件说明。" },
  { href: "/admin/stats", label: "轻量统计", description: "查看 daily_stats 与用户、内容、举报基础读数。" },
